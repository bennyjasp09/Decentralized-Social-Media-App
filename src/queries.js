...
export const APIURL = "https://cors-anywhere.herokuapp.com/https://api.lens.dev";


export const LENS_HUB_CONTRACT_ADDRESS = "0xDb46d1Dc155634FbC732f92E853b10B288AD5a1d";

// Create urql client with required exchanges
export const urlClient = createClient({
  url: APIURL,
  exchanges: [cacheExchange, fetchExchange], // Removed dedupExchange
});
